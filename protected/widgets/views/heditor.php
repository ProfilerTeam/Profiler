...
$(document).ready(function () {
    ...
    var emojis = ["Ambivalent", "Angry", "Confused", "Cool", "Flag_DK", "Flag_GB", "Frown", "Gasp", "Grin", "Heart", "Hearteyes", "Laughing", "Poop", "Slant", "Smile", "ThumbsUp", "ThumbsDown", "Wink", "Yuck"];
    ...
    $('#<?php echo $id; ?>_contenteditable').atwho({
        ...
        tpl: "<li data-value='@${name}'><img class='img-rounded' src='${image}' height='10' width='10' alt=''> ${name}</li>",
    ...
    // Hashtag script
    $('#<?php echo $id; ?>_contenteditable').hashtags();
