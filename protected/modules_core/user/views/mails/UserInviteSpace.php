                        ...
                        <tr>
                            <td valign="top">
                             ...
                             <span style="color: #555555; font-weight: 300;">
                               <?php echo Yii::t('UserModule.views_mails_UserInviteSpace', 'You received a <strong>group</strong> invite'); ?>
                             </span>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" align="center" >
                                                ...
                                                <tr>
                                                    <td  style="font-size: 14px; line-height: 22px; padding-left: 50px; padding-right: 50px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">
                                                        ...
                                                        <!-- START: CONTENT -->
                                                        <?php echo Yii::t('UserModule.views_mails_UserInviteSpace', 'invited you to the group:'); ?>
                                                        <strong><?php echo CHtml::encode($workspaceName); ?></strong>
                                                        at <?php echo CHtml::encode(Yii::app()->name); ?>.<?php echo Yii::t('UserModule.views_mails_UserInviteSpace', '<br>A social network with the aim of keeping you safe while having fun :)<br>Register now
