<div class="panel panel-default">
    <div class="panel-heading"><?php echo Yii::t('AdminModule.views_space_index', '<strong>Manage</strong> groups'); ?></div>
    <div class="panel-body">
        ...
        <p>
            <?php echo Yii::t('AdminModule.views_space_index', 'This overview is used for managing groups.'); ?>
        </p>
