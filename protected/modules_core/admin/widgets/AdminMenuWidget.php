...
class AdminMenuWidget extends MenuWidget
{
    ...
    public function init()
    {
        ...
        $this->addItemGroup(array(
            'id' => 'manage',
            'label' => Yii::t('AdminModule.widgets_AdminMenuWidget', '<strong>Admin</strong> menu'),
            'sortOrder' => 100,
        ));
        ...
        $this->addItem(array(
            ...
            'id' => 'groups',
            'url' => Yii::app()->createUrl('admin/groups'),
            'icon' => '<i class="fa fa-inbox"></i>',
            'group' => 'manage',
            'sortOrder' => 400,
            'isActive' => (Yii::app()->controller->module && Yii::app()->controller->module->id == 'admin' && Yii::app()->controller->id == 'groups'),
            'isVisible' => Yii::app()->user->isAdmin(),
            'newItemCount' => 0
        ));
        $this->addItem(array(
