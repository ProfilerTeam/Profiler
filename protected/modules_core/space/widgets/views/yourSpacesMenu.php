<div class="well sidebar-nav">
    <ul class="nav nav-list">
        ...
        <li class="<?php if ($this->getController()->id == 'dashboard'): ?>active<?php endif; ?>"><a href="<?php echo $this->createUrl('//dashboard/index') ?>">All Group</a></li>
    ...
    <br>
    <a href="<?php echo $this->createUrl('//space/create') ?>" class="btn"><i class="fa fa-plus"></i> New Group</a>
</div>
