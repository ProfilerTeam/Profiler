        ...
        <?php
            echo '<i class="fa fa-dot-circle-o"></i><br>' . Yii::t('SpaceModule.widgets_views_spaceChooser', 'Groups');
        ?>
        ...
        <?php if (Yii::app()->user->canCreateSpace()): ?>
            <li>
                <div class="dropdown-footer">
                    <?php
                    echo CHtml::link(Yii::t('SpaceModule.widgets_views_spaceChooser', 'Create new group'), $this->createUrl('//space/create/create'), array('class' => 'btn btn-info col-md-12', 'data-toggle' => 'modal', 'data-target' => '#globalModal'));
                    ?>
                </div>
            </li>
        <?php endif; ?>
