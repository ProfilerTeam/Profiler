    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?php echo Yii::t('SpaceModule.views_create_create', '<strong>Create</strong> new group'); ?></h4>
        </div>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <label><?php echo Yii::t('SpaceModule.views_create_create', 'How you want to name your group?'); ?></label>
                <?php print $form->textField($model, 'name', array('class' => 'form-control', 'placeholder' => Yii::t('SpaceModule.views_create_create', 'group name'))); ?>
                <?php echo $form->error($model, 'name'); ?>

            </div>
            <div class="form-group">
                <label><?php echo Yii::t('SpaceModule.views_create_create', 'Please write down a small description for other users.'); ?></label>
                <?php print $form->textArea($model, 'description', array('class' => 'form-control', 'rows' => '3', 'placeholder' => Yii::t('SpaceModule.views_create_create', 'group description'))); ?>
            </div>
            ...
            <div id="collapse-access-settings" class="panel-collapse collapse">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="radio">
                            <label class="tt" data-toggle="tooltip" data-placement="top"
                                   title="<?php echo Yii::t('SpaceModule.views_create_create', 'Users can also apply for a<br>membership to this group'); ?>">
                        ...
                        <div class="radio">
                            <label class="tt" data-toggle="tooltip" data-placement="top"
                                   title="<?php echo Yii::t('SpaceModule.views_create_create', 'Every user can enter your group<br>without your approval'); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if (Yii::app()->user->canCreatePublicSpace() && Yii::app()->user->canCreatePrivateSpace()): ?>
                            <div class="radio">
                                <label class="tt" data-toggle="tooltip" data-placement="top"
                                       title="<?php echo Yii::t('SpaceModule.views_create_create', 'Also non-members can see this<br>group, but have no access'); ?>">
                            ...
                            <div class="radio">
                                <label class="tt" data-toggle="tooltip" data-placement="top"
                                       title="<?php echo Yii::t('SpaceModule.views_create_create', 'This group will be hidden<br>for all non-members'); ?>">
