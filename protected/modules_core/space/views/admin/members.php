...
<div class="panel-heading">
    <?php echo Yii::t('SpaceModule.views_admin_members', '<strong>Manage</strong> your group members'); ?>
</div>
<div class="panel-body">

    <?php echo Yii::t('SpaceModule.views_admin_members', 'In the area below, you see all active members of this group. You can edit their privileges or remove it from this group.'); ?>
        ...
        <table class="table table-hover">
            ...
            <?php foreach ($members as $membership) : ?>
                ...
                <tr>
                    ...
                    <?php if (!$space->isSpaceOwner($user->id)) : ?>
                        ...
                        <td style="vertical-align:middle">
                            ...
                            $this->widget('application.widgets.ModalConfirmWidget', array(
                                ...
                                'message' => Yii::t('SpaceModule.views_admin_members', 'Are you sure, that you want to remove this member from this group?'),
                    ...
                    <?php else: ?>
                        <td colspan="3">
                            <div class="space-owner"><?php echo Yii::t('SpaceModule.views_admin_members', 'Group owner'); ?></div>
                        </td>
                        <td></td>
                    <?php endif; ?>
    ...
    <?php if ($space->isSpaceOwner()): ?>
        <p>
            <a data-toggle="collapse" id="space-owner-link" href="#collapse-space-owner" style="font-size: 11px;"><i
                    class="fa fa-caret-right"></i> <?php echo Yii::t('SpaceModule.views_admin_members', 'Change group owner') ?>
            </a>
        </p>
        <div id="collapse-space-owner" class="panel-collapse collapse">
            <div class="well well-sm">

                <p>    <?php echo Yii::t('SpaceModule.views_admin_members', 'The group owner is the super admin of a group with all privileges and normally the creator of the group. Here you can change this role to another user.') ?></p>
...
<?php if (count($space->applicants) != 0) : ?>
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <p>
                <?php echo Yii::t('SpaceModule.views_admin_members', "The following users waiting for an approval to enter this group. Please take some action now."); ?>
            </p>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <p>
            <?php echo Yii::t('SpaceModule.views_admin_members', "The following users were already invited to this group, but haven't accepted the invitation yet."); ?>
