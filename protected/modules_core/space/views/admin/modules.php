<div class="panel panel-default">
    <div class="panel-heading">
        <?php echo Yii::t('SpaceModule.views_admin_modules', '<strong>Group</strong> Plugins'); ?>
    </div>
    <div class="panel-body">

        <?php if (count($availableModules) == 0): ?>
            <p><?php echo Yii::t('SpaceModule.views_admin_modules', 'Currently there are no plugins available for this group!'); ?></p>
        <?php else: ?>
            <?php echo Yii::t('SpaceModule.views_admin_modules', 'Enhance this group with plugins.'); ?><br>
        <?php endif; ?>
                ...
                <div class="media-body">
                    ...
                    <?php if ($this->getSpace()->isModuleEnabled($moduleId)) : ?>
                        ...
                        <?php if ($this->getSpace()->canDisableModule($moduleId)): ?>
                            <?php echo HHtml::postLink(Yii::t('SpaceModule.views_admin_modules', 'Disable'), array('//space/admin/disableModule', 'moduleId' => $moduleId, 'sguid' => $this->getSpace()->guid), array('class' => 'btn btn-sm btn-primary', 'confirm' => Yii::t('SpaceModule.views_admin_modules', 'Are you sure? *ALL* plugin data for this group will be deleted!'))); ?>
                        <?php endif; ?>
