 ...
 *
 * @author Zak
 * @package profiler.modules_core.space.controllers
 * @since 0.5
 */
class AdminController extends Controller
{
    ...
    public function adminOnly()
    {
        if (!$this->getSpace()->isAdmin())
            throw new CHttpException(403, 'Access denied - Group Administrator only!');
    }
    ...
    public function ownerOnly()
    {
        ...
        if (!$workspace->isSpaceOwner() && !Yii::app()->user->isAdmin())
            throw new CHttpException(403, 'Access denied - Group Owner only!');
    }
