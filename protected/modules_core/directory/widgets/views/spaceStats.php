...
<div class="panel panel-default spaces" id="new-spaces-panel">
    ...
    <div class="panel-heading">
        <?php echo Yii::t('DirectoryModule.widgets_views_spaceStats', '<strong>New</strong> groups'); ?>
    </div>
...
<div class="panel panel-default" id="spaces-statistics-panel">
    ...
    <div class="panel-heading">
        <?php echo Yii::t('DirectoryModule.widgets_views_spaceStats', '<strong>Group</strong> stats'); ?>
    </div>

    <div class="panel-body">
        <div class="knob-container" style="text-align: center; opacity: 0;">
            <strong><?php echo Yii::t('DirectoryModule.widgets_views_spaceStats', 'Total groups'); ?></strong><br><br>
        ...
        <div class="knob-container" style="text-align: center; opacity: 0;">
            <strong><?php echo Yii::t('DirectoryModule.widgets_views_spaceStats', 'Private groups'); ?></strong><br><br>
