...
/**
 * @see Zend_Gdata_Media_Extension_Media
 */
// require_once 'Zend/Gdata/Media/Extension/Media.php';
...
class Zend_Gdata_Media_Extension_MediaGroup extends Zend_Gdata_Extension
{
    ...
    /**
     * @var Zend_Gdata_Media_Extension_Media
     */
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        switch ($absoluteNodeName) {
            ...
            case $this->lookupNamespace('media') . ':' . 'copyright';
                $copyright = new Zend_Gdata_Media_Extension_Media();
    ...
    /**
     * @return Zend_Gdata_Media_Extension_Media
     */
    public function get()
    {
    ...
    /**
     * @param Zend_Gdata_Media_Extension_Media $value
     * @return Zend_Gdata_Media_Extension_MediaGroup
     */
