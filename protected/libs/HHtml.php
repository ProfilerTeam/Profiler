...
class HHtml extends CHtml
{
    ...
    {
        $emojis = array('Ambivalent', 'Angry', 'Confused', 'Cool', 'Flag_DK', 'Flag_GB', 'Frown', 'Gasp', 'Grin', 'Heart', 'Hearteyes', 'Laughing', 'Naughty', 'Poop', 'Slant', 'Smile', 'ThumbsUp', 'ThumbsDown', 'Wink', 'Yuck');
